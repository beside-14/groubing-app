...
import CautionIcon from "../../assets/icon/button/caution_icon_gray.png";
        ...
        <View style={styles.container}>
          ...
          {showFindId && (
            <View style={styles.bodyContainer}>
              <View style={styles.emojiContainer}>
                <Image
                  source={require("../../assets/icon/emoji/emoji_01.png")}
                  style={styles.emoji}
                />
          ...
          {showLogin && (
            <View style={styles.bodyContainer}>
              <View style={styles.emojiContainer}>
                <Image
                  source={require("../../assets/icon/emoji/emoji_02.png")}
                  style={styles.emoji}
                />
                <Text style={styles.emojiTxt}>{emojiTxt}</Text>
              </View>
